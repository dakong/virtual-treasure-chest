...
def student():
  if request.method == 'POST':
    ...
    student = Student(first_name=studentData['first_name'], last_name=studentData['last_name'], active=True, points=0)
...
def treasure_item():
  if request.method == 'POST':
    ...
    treasureItem = TreasureItem(cost=cost, name=name, description=description, quantity=quantity)
